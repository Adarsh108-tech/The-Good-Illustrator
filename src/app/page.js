...
export default function Home() {
  return (
    ...
    <section
  id="home"
  className="h-screen flex flex-col md:flex-row justify-center items-center px-6 bg-gradient-to-b from-emerald-50 to-white"
>
  {/* Left Column: Floating Images */}
  <div className="w-full md:w-1/2 h-96 md:h-full relative mb-10 md:mb-0">
    <FloatingImagesWithBackground />
  </div>

  {/* Right Column: Text Content */}
  <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pl-12 text-center md:text-left">
    <motion.h1
    ...
    >
      ...
      you visualize your plans for
      our clean future, showcase
      your innovations, and
      spotlight the remarkable
      impact you are making on
    ...
    >
      <Link
        href="#about"
        className="bg-emerald-600 text-white px-6 py-3 rounded-2xl shadow-md hover:bg-emerald-700 transition"
      >
        Learn More
      </Link>
    </motion.div>
...
<section
  id="about"
  className="py-24 px-6 bg-white scroll-mt-24"
>
  <div className="max-w-6xl mx-auto bg-[#CCDCE1] p-10 rounded-xl flex flex-col md:flex-row items-end gap-10">
    ...
    <div className="w-full md:w-1/3 text-left">
      <h2 className="text-4xl font-semibold mb-6 text-emerald-700">
        About Me
      </h2>

      {/* Content List */}
      <ul className="text-gray-700 text-lg space-y-4 leading-relaxed list-disc list-inside">
        <li><strong>In Vienna, Austria till 2019:</strong></li>
        ...
        <li><strong>In Milan, Italy from 2019:</strong></li>
        <ul className="list-inside list-disc ml-5 space-y-1">
        ...
        <li><strong>Other:</strong> cooking Knödel, Strudel, Carbonara and Pizza, wicked knowledge about sustainability, basic mountaineering, hugging</li>
      </ul>
    </div>
    ...
    <div className="w-full md:w-1/3 flex justify-center md:justify-end">
      ...
      <section
        id="mission"
        className="py-24 px-6 bg-emerald-50 scroll-mt-24 text-center"
      >
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            This Part will contain the work experience 
          </p>
        </div>
      </section>

      {/* Contact Section */}
      <section id="contact" className="py-24 px-6 bg-white scroll-mt-24">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-semibold mb-6 text-emerald-700">
            Get in Touch
          </h2>
          <p className="text-gray-600 text-lg mb-6">
            Have ideas, want to collaborate, or wish to support ?
